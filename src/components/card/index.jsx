...
const Card = () => {
  return (
    <CardContainer>
      ...
      <Content>
        <UserInfo>
          <UserPicture src="https://media-exp1.licdn.com/dms/image/C4D03AQGThKEaGPhJxQ/profile-displayphoto-shrink_200_200/0/1642428236472?e=1673481600&v=beta&t=-0Lx6IhyiJYgGdm5inDMONESJj413aT-gEkXOerRpNU"/>
         <div>
          <h4>Pablo Kenedy</h4>
          <p>Há 3 minutos</p>
        </div> 
        ...
        <PostInfo>
          ...
          <p>Projeto feito no curso de HTML e CSS no Bootcamp...<strong><br/><br/>Saiba Mais</strong></p>
        </PostInfo>
        <HasInfo>
          <h4>#HTML | #CSS | #Javascript | #Dio | #React</h4>
          <p>
            <FiThumbsUp />10
          </p>
        </HasInfo>
